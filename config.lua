...
Config.ClothingShops = {
	...
	[17] = {
		blip = false,
		coords = vector3(1842.83, 3679.2, 34.19),
	...
	[21] = {
		blip = false,
		coords = vector3(461.32, -996.48, 30.69),
		MarkerSize   = {x = 2.0, y = 2.0, z = 0.0}
	},
	[22] = {
		blip = false,
		coords = vector3(300.67, -597.65, 43.29),
		MarkerSize   = {x = 2.0, y = 2.0, z = 0.0}
	},
	[23] = {
        blip = false,
        coords = vector3(-312.54, -1369.1, 18.28),
        MarkerSize   = {x = 4.0, y = 4.0, z = 1.0}
    },
	[24] = {
        blip = false,
        coords = vector3(-1819.95, 434.76, 132.31),
        MarkerSize   = {x = 1.5, y = 1.5, z = 1.0}
    },
	[24] = {
        blip = false,
        coords = vector3(-264.92, -733.75, 125.47),
        MarkerSize   = {x = 1.5, y = 1.5, z = 1.0}
    },
}
